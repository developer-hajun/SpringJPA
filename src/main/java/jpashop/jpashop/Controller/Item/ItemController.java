package jpashop.jpashop.Controller.Item;
...
public class ItemController {
    ...
    public String update(@PathVariable Long id,@ModelAttribute("form") BookForm form){
        //Book이 파라미터 형식으로 넘어옴 -> 준영속 Entity
        /*Book book = new Book();
